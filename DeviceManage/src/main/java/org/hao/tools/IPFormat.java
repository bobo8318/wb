...
public class IPFormat {
	...
	public static long iptolong(String strip){//将127.0.0.1形式的ip地址转换成10进制整数，这里没有进行任何错误处理 
	...
	public static String longtoip(long longip) {//将10进制整数形式转换成127.0.0.1形式的ip地址，在命令提示符下输入ping3396362403l 
